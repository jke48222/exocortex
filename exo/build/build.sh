...
swiftc -O -swift-version 5 \
  src/Store.swift src/Embed.swift src/VectorIndex.swift src/Exclusion.swift src/Capture.swift src/ClaudeCode.swift src/Browser.swift src/IMessage.swift src/FileEvents.swift src/Bar.swift \
