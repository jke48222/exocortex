...
swiftc -O -swift-version 5 \
  ...
  src/Ledger.swift src/Extract.swift src/Contradict.swift src/Connect.swift src/Segment.swift src/Decay.swift src/Promise.swift src/Butler.swift src/Retention.swift src/main.swift \
